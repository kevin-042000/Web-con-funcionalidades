...
class C_c_noticias extends CI_Controller {
	...
	public function save()
	{
		...
		header('Location: https://veracious-plating.000webhostapp.com/index.php/C_c_noticias ');
	}
	...
	public function eliminar($id)
	{
		...
		redirect('https://veracious-plating.000webhostapp.com/index.php/C_c_noticias ');
	}
